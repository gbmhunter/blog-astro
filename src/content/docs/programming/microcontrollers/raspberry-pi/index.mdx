...
// import _images_project_autoelectricblanket_simple_led_connected_to_raspberry_pi_gpio from '/images/project-autoelectricblanket/simple-led-connected-to-raspberry-pi-gpio.jpg'

// <Image src={_images_project_autoelectricblanket_simple_led_connected_to_raspberry_pi_gpio} width="800px">I used a single LED connected up to one of the RaspberryPi's GPIO pins for basic testing.</Image>
