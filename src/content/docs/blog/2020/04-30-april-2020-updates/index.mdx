...
import _docs_electronics_components_shift_registers_serial_in_serial_out_shift_register from '/docs/electronics/components/shift-registers/serial-in-serial-out-shift-register.svg'

<Image src={_docs_electronics_components_shift_registers_serial_in_serial_out_shift_register} width="500px">Schematic for building a 4-bit SISO shift register from flip flops.</Image>
...
import _docs_electronics_components_transformers_typical_flyback_schematic from '/docs/electronics/components/transformers/typical-flyback-schematic.png'

<Image src={_docs_electronics_components_transformers_typical_flyback_schematic} width="600px"></Image>
