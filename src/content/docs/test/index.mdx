...
<A src={cartoonNinja} width="300px" alt="">This should be an clickable image of the logo. **Bold text**. An equation: $x^2$. There should be a footnote number at the end of this sentence[^foot-1].</A>
...
<A src={testImage1000px} width="2000" alt="">A larger test image. Make the screen width small and make sure this image does not exceed 100% page width.</A>
